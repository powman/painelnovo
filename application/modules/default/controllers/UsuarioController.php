...
//         $this->model = new Default_Model_Usuario();
//         $this->modelLog = new Default_Model_Logs();
//         $this->modelUsuarioGrupo = new Default_Model_UsuarioGrupo();
...
//             $sql->where('usuario.nome LIKE ?', "%".$this->getRequest()->getParam('nome')."%");
        
//         if($this->getRequest()->getParam('email'))
//             $sql->where('usuario.email LIKE ?', "%".$this->getRequest()->getParam('email')."%");
        
//         if($this->getRequest()->getParam('id'))
//             $sql->where('usuario.id = ?', $this->getRequest()->getParam('id'));
