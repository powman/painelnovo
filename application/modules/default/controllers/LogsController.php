...
//         $this->model = new Default_Model_Logs();
...
//         if($this->getRequest()->getParam('usuario_id'))
//             $sql->where('usuario_id = ?',$this->getRequest()->getParam('usuario_id'));
        
//         if($this->getRequest()->getParam('usuario_nome'))
//             $sql->where('usuario_nome LIKE ?',"%".$this->getRequest()->getParam('usuario_nome')."%");
        
//         if($this->getRequest()->getParam('descricao'))
//             $sql->where('descricao LIKE ?',"%".$this->getRequest()->getParam('descricao')."%");
